...
def plot(preds, labels, batch_size, error):
    ...
    ax0.errorbar(labels_1_a, preds_1_a, error_1_a, fmt="o", mec="k", mew=0.5, alpha=0.6, capsize=3, color="b", zorder=-130, markersize=4)
    ...
    ax0_1.errorbar(labels_1_b, preds_1_b, error_1_b, fmt="o", mec="k", mew=0.5, alpha=0.6, capsize=3, color="g", zorder=-130, markersize=4)
    ...
    ax1.errorbar(labels_2_a, preds_2_a, error_2_a, fmt="o", mec="k", mew=0.5, alpha=0.6, capsize=3, color="b", zorder=-130, markersize=4)
    ...
    ax2.errorbar(labels_2_b, preds_2_b, error_2_b, fmt="o", mec="k", mew=0.5, alpha=0.6, capsize=3, color="g", zorder=-130, markersize=4)
    ...
    ax3.errorbar(labels_2_c, preds_2_c, error_2_c, fmt="o", mec="k", mew=0.5, alpha=0.6, capsize=3, color="b", zorder=-130, markersize=4)
    ...
    ax4.errorbar(labels_2_d, preds_2_d, error_2_d, fmt="o", mec="k", mew=0.5, alpha=0.6, capsize=3, color="g", zorder=-130, markersize=4)
...
def run_kdp(path_one_layer, path_two_layer, data_path, batch_size=20, n_iter=5):
    ...
    preds_one_layer = kdp_one_layer.predict(loader_one_layer, n_iter=n_iter)
    preds_two_layer = kdp_two_layer.predict(loader_two_layer, n_iter=n_iter)
    ...
    depth_one, depth_two = preds_one_layer[0][0], preds_two_layer[0][0]
    sld_one,   sld_two   = preds_one_layer[0][1], preds_two_layer[0][1]
    
    depth_ground_one, depth_ground_two = preds_one_layer[2][0], preds_two_layer[2][0]
    sld_ground_one,   sld_ground_two   = preds_one_layer[2][1], preds_two_layer[2][1]
    
    depth_std_one, depth_std_two = preds_one_layer[1][0], preds_two_layer[1][0]
    sld_std_one,   sld_std_two   = preds_one_layer[1][1], preds_two_layer[1][1]
